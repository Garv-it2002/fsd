...
from app1.views import enrolledStudentsUsingAjax,generateCSV,registerAjax, home, studentlist,courselist,register,enrolledStudents,add_project,StudentListView,StudentDetailView,generatePDF
